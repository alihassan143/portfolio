...
class ContactSection extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    return div(id: 'contact', classes: 'sec-wrap', [
      div(classes: 'contact-box', attributes: {'data-reveal': 'scale'}, [
        ...
        div(classes: 'socials', [
          a(
            href: 'https://github.com/alihassan143',
            classes: 'soc-link',
            attributes: {'target': '_blank', 'rel': 'noopener noreferrer', 'title': 'GitHub'},
            [
              RawText(
          ...
          a(
            href: 'https://twitter.com/alihassan143co1',
            classes: 'soc-link',
            attributes: {'target': '_blank', 'rel': 'noopener noreferrer', 'title': 'Twitter'},
            [
              RawText(
                '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">'
                '<path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.259 5.631 5.905-5.631zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>',
              ),
            ],
          ),
          a(
